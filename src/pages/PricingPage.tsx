...
const pricingStats = [
	...
	},
	{
		...
		sub: 'No noticeable slowdown',
	},
	{
		value: 'Zero-log',
		label: 'By default',
		sub: 'Nothing stored unless configured',
	},
	{
		value: '1 URL',
		label: 'Change required',
		sub: 'No code rewrite needed',
	},
];
				...
				<div className="mx-auto max-w-4xl text-center">
					...
					>
						...
						<div className="mt-6 space-y-3 text-muted-foreground text-base leading-relaxed text-left max-w-3xl mx-auto">
							<p>Most teams ship LLMs into production with nothing between their app and the model. Prompt injection is the most exploited vulnerability in production LLM systems. The average cost of an AI-related data breach is £1.9M. Fewer than 35% of organisations have any dedicated LLM defence deployed.</p>
