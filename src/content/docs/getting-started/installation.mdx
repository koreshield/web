...
:::note
This guide is for **self-hosted** KoreShield deployments. Hosted customers can skip installation and proceed with the [API integration](/docs/client-integration).
:::
...
- [Client Integration Guide](/docs/client-integration)
