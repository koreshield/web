export const SEOConfig = {
	home: {
		...
		ogImage: 'https://koreshield.ai/og-default.png',
		ogType: 'website' as const,
		structuredData: {
			'@context': 'https://schema.org',
			'@type': 'WebSite',
			'@id': 'https://koreshield.ai/#website',
			name: 'Koreshield',
			url: 'https://koreshield.ai',
			description: 'Enterprise-grade LLM security firewall',
			image: 'https://koreshield.ai/og-default.png',
			publisher: { '@id': 'https://koreshield.ai/#organization' },
			sameAs: [
	...
	about: {
		...
		structuredData: {
			'@context': 'https://schema.org',
			'@type': 'AboutPage',
			'@id': 'https://koreshield.ai/about#webpage',
			url: 'https://koreshield.ai/about',
			name: 'About Koreshield',
			about: { '@id': 'https://koreshield.ai/#organization' },
