    ...
    def get_pii_patterns(self) -> List[Dict[str, Any]]:
        ...
        return [
            ...
            },
            {
                ...
                "context_check": "intercom|company|account|workspace"
            },
            {
                ...
                "context_check": "intercom|conversation|thread|chat|ticket"
            },
            {
            ...
            },
            {
                ...
                "context_check": "intercom|api[_-]?token|api[_-]?|authorization|x-api-key"
            },
            {
                ...
                "context_check": "intercom|app[_-]?id|app[_-]?"
            }
        ]
