...
function PlanCard({
	...
	return (
		<div
			className={`relative flex flex-col p-8 rounded-3xl border transition-all duration-300 ${recommended
		...
		>
			...
			<button
				onClick={onSelect}
				disabled={current}
				className={`w-full py-3 rounded-full font-bold text-center transition-all ${current
