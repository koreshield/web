...
The KoreShield JavaScript/TypeScript SDK provides a comprehensive, production-ready solution for integrating KoreShield's LLM security features into your applications.
...
```html
<script src="https://cdn.jsdelivr.net/npm/koreshield-js@latest/dist/browser/index.global.js"></script>
<script>
const client = KoreShield.createClient({
    baseURL: 'https://your-koreshield-instance.com',
    apiKey: 'your-koreshield-api-key'
});
</script>
...
- 📖 [Full API Documentation](https://koreshield.com/docs/sdk)
- 💬 [GitHub Discussions](https://github.com/1cbyc/koreshield/discussions)
- 🐛 [Report Issues](https://github.com/1cbyc/koreshield/issues)
