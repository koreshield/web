...
```javascript
import { KoreShieldOpenAI } from 'koreshield-js';
...
- 💬 [Community Discussions](https://github.com/1cbyc/koreshield/discussions)
- 🐛 [Report Integration Issues](https://github.com/1cbyc/koreshield/issues)
