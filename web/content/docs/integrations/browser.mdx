...
```html
<script src="https://unpkg.com/koreshield-js@latest/dist/browser/index.global.js"></script>
```

### Specific Version

```html
<script src="https://cdn.jsdelivr.net/npm/koreshield-js@1.0.0/dist/browser/index.global.js"></script>
```
...
```html
<script src="https://your-cdn.com/koreshield-js/index.global.js"></script>
```
