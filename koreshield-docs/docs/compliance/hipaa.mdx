...
Restrict access to PHI by role and account. Ensure requests are scoped to the appropriate patient or case context.

**Practical guidance:**

- enforce role-based access controls in your application
- scope requests by user and patient identifiers
- isolate data by account and environment
...
- **Access control:** application RBAC, account isolation, key management
