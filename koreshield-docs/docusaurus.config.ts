...
const config: Config = {
	...
	themeConfig: {
		...
		footer: {
					...
					items: [
						{
							html: `
								<div class="footer-social-icons">
									<a class="footer-icon-link" href="https://github.com/koreshield/" aria-label="GitHub" target="_blank">
			...
			copyright: `Copyright © ${new Date().getFullYear()} Koreshield. All rights reserved.`,
		},
		// === CODE HIGHLIGHTING ===
		prism: {
